        ...
        <section className=" bg-gray-100 m-8 rounded-md">
                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    ...
                    <p className="max-w-2xl font-semibold text-orange-500 md:text-lg lg:text-2xl capitalize">SALE UP TO 30% OFF</p>
                        ...
                        <a href="#" className="inline-flex bg-primary items-center justify-center px-5 py-3 text-base font-medium text-center text-white border  rounded-lg focus:ring-4 focus:ring-gray-100   ">
                            Speak to Sales
                        </a>
                    </div>
        ...
        <section className="bg-gray-100 m-8 rounded-md">
                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    ...
                    <p className="max-w-2xl font-semibold text-orange-500 md:text-lg lg:text-2xl capitalize">SALE UP TO 30% OFF</p>
                        ...
                        <a href="#" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border  rounded-lg focus:ring-4 focus:ring-gray-100 ">
                            Speak to Sales
                        </a>
                    </div>
                    <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
        ...
        <section className="bg-gray-100 m-8 rounded-md">
                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    ...
                    <p className="max-w-2xl font-semibold text-orange-500 md:text-lg lg:text-2xl capitalize">SALE UP TO 30% OFF</p>
                        ...
                        <a href="#" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border  rounded-lg focus:ring-4 focus:ring-gray-100  hover:bg-gray-700 dark:focus:ring-gray-800">
                            Speak to Sales
                        </a>
                    </div>
                    <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
