                ...
                <div class="flex mx-auto w-full md:w-1/2 ">
                    {interests.map((item) => (
                        ...
                        <div class="h-full bg-gray-100 p-8 rounded">
                            ...
                            <a href="#" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border  rounded-full focus:ring-4 focus:ring-gray-800 border-gray-700 hover:bg-gray-700 hover:text-white ">
                            Shop Now
                        </a>
